<template>
    <div>
        ...
        <div>
            <card>
                CHARTBOOST Accounts
                <l-table class="table table-hover table-striped" :columns="tableColumns" :data="chartboostData">
        ...
        <div align="center" v-if="currentType === 'create'  ">
            <card>
                <fg-input type="text"
                          label="Name"
                          placeholder="name"
                          v-model="newChartboost.name">
                </fg-input>
                <fg-input type="text"
                          label="User Id"
                          placeholder="user_id"
                          v-model="newChartboost.user_id">
                </fg-input>
                <fg-input type="text"
                          label="User Signature"
                          placeholder="user_signature"
                          v-model="newChartboost.user_signature">
                </fg-input>
                <button class="btn btn-info btn-fill align-self-auto" v-on:click="createFirst(newChartboost)">
                    SAVE
                </button>
            ...
            <div align="center">
                <card>
                    ...
                    <fg-input type="text"
                              label="User Id"
                              placeholder="user_id"
                              v-model="rowData.credentials.user_id">
                    </fg-input>
                    <fg-input type="text"
                              label="User Signature"
                              placeholder="user_signature"
                              v-model="rowData.credentials.user_signature">
                    </fg-input>
...
<script>
    ...
    export default {
        ...
        props: ['chartboostData', 'updateNetwork', "createNetwork", "deleteNetwork"],
        data() {
            return {
        ...
        methods: {
            ...
            createFirst(currentData) {
                let credentials = {'user_id': currentData.user_id, 'user_signature': currentData.user_signature}
                this.createNetwork(currentData, credentials)
            },
            updateFirst(rowData) {
                let credentials = {
                    'user_id': rowData.credentials.user_id,
                    'user_signature': rowData.credentials.user_signature
                }
